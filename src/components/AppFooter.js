...
function AppFooter(props) {
  ...
  const subtuneText = `共 ${currentSongNumSubtunes}首，当前第 ${currentSongSubtune + 1} 首`;
        ...
        <div className="AppFooter-main-inner">
          ...
          {currentSongNumSubtunes > 1 &&
            <span style={{ whiteSpace: 'nowrap' }}>
              { songUrl ?
                <a style={{ color: 'var(--neutral1)' }} href={getCurrentSongLink(/*subtune=*/true)}
          ...
          {!ejected &&
            <div className="SongDetails">
              ...
              <div className="SongDetails-title">
                { songUrl ?
                  <>
                    <a style={{ color: 'var(--neutral1)' }} href={getCurrentSongLink()}
      ...
      {(showPlayerSettings && false) && // TODO: Remove footer settings
        <div className="AppFooter-settings">
          <div style={{
            ...
            <h3 style={{ margin: '0 8px 0 0' }}>播放器设置</h3>
            <button className='box-button' onClick={toggleSettings}>
              Close
            </button>
          </div>
